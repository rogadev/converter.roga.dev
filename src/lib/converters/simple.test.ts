...
describe("Converter Utilities (Node.js compatible)", () => {
  ...
  describe("renameFile", () => {
    ...
    it("should handle complex filenames", () => {
      ...
      expect(renameFile("file-with-dashes_and_underscores.png", "avif")).toBe(
        "file-with-dashes_and_underscores.avif",
      );
    });
  ...
  describe("Workflow Integration", () => {
    ...
    it("should handle batch processing workflow", () => {
      const files = ["image1.jpg", "image2.png", "video1.mp4", "document.pdf"];
