...
describe("error-handler", () => {
  ...
  describe("handleConversionError", () => {
    ...
    it("should handle SharedArrayBuffer errors", () => {
      ...
      expect(result).toBe(
        "Video conversion requires secure context (HTTPS). Please check your browser settings.",
      );
    });
    ...
    it("should handle out of memory errors", () => {
      ...
      expect(result).toBe(
        "File too large for conversion. Try a smaller file or reduce quality settings.",
      );
    });
    ...
    it("should handle null and undefined errors", () => {
      ...
      expect(handleConversionError(undefined)).toBe(
        "Unknown error occurred during file conversion",
      );
      expect(handleConversionError(null, "image")).toBe(
        "Unknown error occurred during image conversion",
      );
    });
    ...
    it("should prioritize specific error patterns over generic handling", () => {
      ...
      const complexError = new Error(
        "Failed to initialize: SharedArrayBuffer is not available in this context",
      );
    ...
    it("should handle case-sensitive error detection", () => {
      ...
      expect(handleConversionError(lowerCaseError)).toBe(
        "File too large for conversion. Try a smaller file or reduce quality settings.",
      );
    });
